--[[
    Lynx | ESP Module
    Credit atleast if you're going to use.   
    Wont work for a bit since valyse and electron dont support metatables for the esp?
]]
    ...
    function Visuals:Create(Properties)
        if Properties then
            if Properties.Player then
                ...
                -- 
                --if (Settings.TeamCheck and not (Lynx:CheckTeam(LocalPlayer, Properties.Player))) then Self:Remove() end  EDIT THIOS
                --
                return Self
            end
        end
    ...
    function Visuals.Base:Update()
        ...
        if Self then
            ...
            if (Player and Parent and Parent ~= nil) or (Info.RootPosition and Info.Health and Info.MaxHealth) then
                local TeamCheck = (Settings.TeamCheck and (Lynx:CheckTeam(LocalPlayer, Player))) 
                if (Settings.Enabled == true) then
                    ...
                    if Info.RootPosition and Info.Health and Info.MaxHealth then
                        ...
                        if (Size and BoxSize and BoxPosition) then
                            ...
                            --
                            do -- // Name
                                if (Settings["Name"][1] == true) and TeamCheck then
                            ...
                            --
                            do -- // Corner Boxes
                                if (Settings["Box"][1] == true) and TeamCheck then
                                ...
                                --
                                if (Settings["BoxFill"][1] == true) and TeamCheck then
                            ...
                            --
                            do -- // HeatlhBar
                                if (Settings["HealthBar"][1] == true) and TeamCheck then
                                    ...
                                    --
                                    do -- // Value
                                        if (Settings["HealthNumber"][1] == true) and TeamCheck then
                            ...
                            --
                            do -- // Weapon
                                if (Settings["Weapon"][1] == true) and TeamCheck then
                            ...
                            --
                            do -- // Distance
                                if (Settings["Distance"][1] == true) and TeamCheck then
                            ...
                            --
                            do -- // Flag
                                if (Settings["Flag"][1] == true) and TeamCheck then
